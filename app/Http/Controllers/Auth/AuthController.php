    ...
    {	
	 ...
	 //print_r($request->all());die;
		...
		//print_r($validatedData);die;
		 ...
		 $patient = Patient::where('patient_sus','=',$validatedData['name'])
				->orWhere('patient_rg','=',$validatedData['name'])
				->orWhere('patient_CPF', '=', $validatedData['name'])
				->count();
				//print_r($patient);die;
		if($patient>0){
			//echo "testing";die;
        ...
        session()->flash('message', 'Your are logged In');       
