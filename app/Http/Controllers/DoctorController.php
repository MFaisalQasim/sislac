...
//                if ($request->TimeSlot[0]['from'] == null && $request->TimeSlot[0]['to'] == null) {
                    ...
                    $fullnamearray=explode(' ',$request->full_name);
                 
                     $validatedData['first_name']=$fullnamearray[0];
                     $validatedData['last_name']=$fullnamearray[1]??'';
...
//                        }
//                    }
                    return redirect('doctor')->with('success', 'Médico criado com sucesso!');
//               } else {
//                }
            } catch (Exception $e) {
                dd($e->getMessage());
    ...
    public function update(Request $request, User $doctor)
    {
        ...
        if ($user->hasAccess('doctor.update')) {
            ...
            try {
                ...
                $doctor->first_name =$fullnamearray[0];
                $doctor->last_name=$fullnamearray[1]??'';
