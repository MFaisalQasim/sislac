...
<body data-topbar="dark" data-layout="horizontal">
    ...
    <div class="">
           ...
           @component('components.breadcrumb')
            @slot('title') Lista De Citologia @endslot
            @slot('li_1') Dashboard @endslot
            @slot('li_2') Citologia @endslot
        @endcomponent
        <!-- end page title -->
            ...
            <div class="card-body">
                  ...
                  <div class="row">
                        <div class="col-lg-3">
                            ...
                            <a href="{{route('CreateCytology')}}">
                                <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                                    <i class="bx bx-plus font-size-16 align-middle mr-2"></i> {{ __('Nova Citologia') }}
                                </button>
                            </a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="getsubItemApi({{ $item->id }})" data-toggle="modal" data-target="subCytologyModal">
                                            ...
                                            <a href="{{route('EditCytology',['id'=>$item->id])}}">
                                                <button type="button" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light mb-2 mb-md-0" title="Update Profile">
                                                    <i class="mdi mdi-lead-pencil"></i>
                                                </button>
                                            </a>
                                            <form action="{{ route('DeleteCytology',['id'=>$item->id])}}" method="POST" class="d-inline">
                                                <!--@csrf
                                                @method('DELETE')-->
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
                                                ...
                                                <form id="cytologysubitemForm"">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <input type="hidden" name="cytology_Id" value="{{$item->id}}" />
                                                        </div>
