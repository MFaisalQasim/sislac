                        ...
                        <div class="col-lg-12">
                            <div class="detail_box">
                                <div class="detail_box">
                                    ...
                                    <form action="{{ route('UpdateCytology',['id'=>$cytology->id]) }}" name="doctorform" class="" method="post">
                                        @csrf
                                        @method('put')
                                        ...
                                        <table class="table sislac_table table_form">
                                            ...
                                            <tbody>
                                            <th><input class="form-control" name="category_name" type="text" value="{{$cytology->name}}"/></th>
