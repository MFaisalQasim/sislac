                    ...
                    @if ($role == 'admin')
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                <a href="{{ url('doctor') }}" class="dropdown-item">{{ __('Lista de Médicos') }}</a>
                                <a href="{{ route('doctor.create') }}"
                                    class="dropdown-item">{{ __('Novo Médico') }}</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layout" role="button"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                ...
                                <a href="{{ route('receptionist.create') }}"
                                    class="dropdown-item">{{ __('Novo Recepcionista') }}</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                ...
                                <a class="dropdown-item" href="{{ route('createAppointment') }}">
                                    {{ __('Novo Atendimento') }}
                                </a>
                                <a class="dropdown-item" href="{{ url('inserir-resultado') }}">
                                    {{ __('Inserir Resultado') }}
                                </a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                ...
                                <a class="dropdown-item" href="{{ route('cytology') }}">
                                    {{ __('Citologia') }}
                                </a>
