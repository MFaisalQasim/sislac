            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="@if ($receptionist) {{ url('receptionist/' . $receptionist->id) }} @else {{ route('receptionist.store') }} @endif" method="post" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            @if ($receptionist)
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror"
                                                name="email" tabindex="3" id="email" value="@if ($receptionist){{ $receptionist->email }}@elseif(old('email')){{ old('email') }}@endif" autocomplete="off"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label">{{ __('Password') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" pattern=".{8,}"   autocomplete="off" required title="8 characters minimum"/>
                                            @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
