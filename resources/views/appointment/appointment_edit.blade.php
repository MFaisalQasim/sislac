            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route("appointment.update",['id' => $appointment->id])}}" id="" method="POST" onsubmit="return ValidationEvent()">
                            @csrf
                             @method('PUT')
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input type="hidden" name="user_id" id="user_id" value="{{$appointment->user_id}}" />
                                                <input type="hidden" name="patientname" id="patientname" value="{{$appointment->patient_name}}" />
                                            ...
                                            <div class="col-md-1 form-group">
                                                    ...
                                                    <select class="form-control" name="gender" id="gender">
                                                        <option {{ ($appointment->gender=='Masculino')?'selected':''}}>Masculino</option>
                                                        <option {{ ($appointment->gender=='Feminino')?'selected':''}}>Feminino</option>
                                                    </select>
                                            </div>
                                            <div class="col-md-2 form-group">
                                                ...
                                                <input type="text" class="form-control" name="birthdate" id="birthdate" value="{{$appointment->birthdate}}" />
                                            </div>
                                            <div class="col-md-1 form-group">
                                                <label class="control-label">{{__('Idade')}} </label>
                                                <input type="number" class="form-control" name="age" id="age"  value="{{$appointment->age}}" />
                                            </div>
                                            <div class="col-md-2 form-group">
                                                <label class="control-label">{{__('CPF')}}</label>
                                                <input type="text" class="form-control" name="cpf" id="patient_CPF" value="{{$appointment->cpf}}" />
                                            </div>
                                            <div class="col-md-2 form-group">
                                                <label class="control-label">{{__('Responsável')}}</label>
                                                <input type="text" class="form-control" name="responsible"  id="responsible" value="{{$appointment->responsible}}"/>
                                            </div>
                                            <div class="col-md-2 form-group">
                                                <label class="control-label">{{__('CEP')}}</label>
                                                <input type="number" class="form-control" name="zip_code" id="zip_code"  value="{{$appointment->zip_code}}" />
                                            </div>
                                            <div class="col-md-2 form-group">
                                                <label class="control-label">{{__('Cidade')}}</label>
                                                <input type="text" class="form-control" name="city" id="city" value="{{$appointment->city}}" />
                                            </div>
                                            <div class="col-md-4 form-group">
                                                    <label class="control-label">{{__('Endereço')}}</label>
                                                    <input type="text" class="form-control" name="address" id="address" value="{{$appointment->address}}"  />
                                            </div>
                                            <div class="col-md-2 form-group">
                                                    <label class="control-label">{{__('Telefone')}}</label>
                                                    <input type="phone" class="form-control" name="phone" id="phone" value="{{$appointment->phone}}" />
                                            </div>
                                            
                                            <div class="col-md-2 form-group">
                                                    <label class="control-label">{{__('E-mail')}}</label>
                                                    <input type="email" class="form-control" name="email" id="email"  value="{{$appointment->email}}" />
                                            </div>
                                            <!--
                            ...
                            <div class="row">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <select class="form-control js-example-basic-single" name="crm" id="selectcrm" required onchange="selectdoctor(this.value)">
                                                @foreach($doctors as $doc)
                                                    <option value="{{$doc->id}}" {{($appointment->appointdoctor->id == $doc->id)?"selected":""}}>{{$doc->id}} | {{ $doc->full_name }} </option>
                                                @endforeach
                                            </select>
                                        ...
                                        -->
                                        <input type="hidden" class="form-control" id="doctor_name" name="doctor" value="{{$appointment->doctor}}" required />
                                        <div class="col-md-2 form-group">
                                            <label class="control-label">{{__('Código')}}</label>
                                            <input type="text" class="form-control" name="code"  value="{{$appointment->code}}"/>
                                        </div>
                                        <div class="col-md-2 form-group">
                                            <label class="control-label">{{__('Plano de saúde')}}</label>
                                            <input type="text" class="form-control" name="insurance" value="{{$appointment->insurance}}" />
                                        </div>
                                        <div class="col-md-2 form-group">
                                            <label class="control-label">{{__('Empresa')}}</label>
                                            <input type="text" class="form-control" name="company"  value="{{$appointment->ins_company}}" />
                                        </div>
                            </div>
                            <hr/>
                            <div class="table-resposive exam-table">
                                <table class="table table-bordered" id="serving">
                                    ...
                                    <tbody>
                                        @if(isset($appointment->exams) && !empty($appointment->exams))
                                            @php
                                            $row=1
                                            @endphp
                                            @foreach($appointment->exams as $product)
                                            <tr id="row-{{$row}}">
                                                <td class="item">
                                                    {{$row}}
                                                </td>
                                                <td  class="abbreviation d-flex">
                                                    ...
                                                    <input type="hidden" name="exam[{{$row}}][name]" class="examname" value="{{$product->name}}"/>
                                                    <select  name="exam[{{$row}}][id]" class="form-control examnameselect"  onchange="addexam({{$row}})">
                                                       <!-- <option disabled>ID | Abbreviation</option>-->
                                                        @foreach($examlist as $exam)
                                                        <option value="{{$exam->id}}" {{($product->id == $exam->id)?"selected":''}}>{{$exam->abbreviation}} | {{$exam->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td class="examambcode">{{$product->id}}</td>
                                                <td class="examdate">{{$today}}</td>
                                                <td>
                                                    <input type="text" name="exam[{{$row}}][price]" class="price" value="{{$product->exam_price}}" readonly/>
                                                </td>
                                            </tr>
                                            @php($row++)
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                            <div class="col-md-2 form-group">
                                                ...
                                                <input type="date" class="form-control" name="delivery_date"  value="{{$appointment->appointment_date}}" required/>
                                            </div>
                                            <div class="col-md-4 form-group">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <input type="text" class="form-control" name="medicines"  value="{{$appointment->medicines}}"/>
                                            </div>
                                            <div class="col-md-12 form-group">
                                                <label class="control-label">{{__('Observações')}}</label>
                                                <input type="text" class="form-control" name="comments" value="{{$appointment->comments}}" />
                                            </div>
