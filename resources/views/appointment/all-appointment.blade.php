...
@section('title') {{ __('Lista De Atendimentos') }} @endsection
@section('body')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                            ...
                            -->
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ url('all-appointment') }}">
                                    <span class="d-block d-sm-none"><i class="fas fa-calendar-day"></i></span>
                            ...
                            <div class="tab-pane active" id="PendingAppointmentList" role="tabpanel">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>    
                                                            <button type="button" class="btn btn-primary complete btn-sm btn-rounded waves-effect waves-light mb-2 mb-md-0"
                                                                data-id="{{ $item->id }}"><i class="mdi mdi-checkbox-marked-circle-outline"></i>
                                ...
                                <div class="col-md-12 text-center mt-3">
                                    <div class="d-flex justify-content-start">
                                        Mostrando de  {{ $pending_appointment->firstItem() }} a
