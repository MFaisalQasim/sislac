                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-9 text-right">
                                <form action="">
                                    <div class="form-group d-inline-flex">
                                        <input class="form-control mr-1" type="text" placeholder="Pesquisar CPF" name="search_crm" value="{{$searchCRM}}" />
                        ...
                        <div class="col-md-12 text-center mt-3">
                            <div class="d-flex justify-content-start">
                                Mostrando de {{ $patients->firstItem() }} a {{ $patients->lastItem() }} de
                                {{ $patients->total() }} entradas
                            </div>
