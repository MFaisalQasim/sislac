                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <select class="form-control @error('gender') is-invalid @enderror" tabindex="3"
                                                ...
                                                <option value="Masculino" @if (($patient_info && $patient_info->gender == 'Masculino') || old('gender') == 'Masculino') selected @endif>{{ __('Masculino') }}</option>
                                                <option value="Feminino" @if (($patient_info && $patient_info->gender == 'Feminino') || old('gender') == 'Feminino') selected @endif>{{ __('Feminino') }}
                                                </option>
