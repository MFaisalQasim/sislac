                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-9 text-right">
                                <form action="">
                                    <div class="form-group d-inline-flex">
                                        <input class="form-control mr-1" type="text" placeholder="Pesquisar CPF" name="search_crm" value="<?php echo e($searchCRM); ?>" />
                        ...
                        <div class="col-md-12 text-center mt-3">
                            <div class="d-flex justify-content-start">
                                Mostrando de <?php echo e($patients->firstItem()); ?> a <?php echo e($patients->lastItem()); ?> de
                                <?php echo e($patients->total()); ?> entradas
                            </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u931124233/domains/sislac.com.br/public_html/resources/views/patient/patients.blade.php ENDPATH**/ ?>