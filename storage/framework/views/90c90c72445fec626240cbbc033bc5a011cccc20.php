                        ...
                        <div class="table-responsive">
                            <table class="table mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row"><?php echo e(__('Birth Date :')); ?></th>
                                        <td> <?php echo e($patient_info->patient_dob); ?> </td>
                                    </tr>
                                   
                                    <tr>
                                        <th scope="row"><?php echo e(__('Age:')); ?></th>
                                        <td> <?php echo e($patient_info->patient_rg); ?> </td>
                                    </tr>
									 <tr>
                                        <th scope="row"><?php echo e(__('Telephone:')); ?></th>
                                        <td> <?php echo e($patient->mobile); ?> </td>
                                    </tr>
                                 
                                    <tr>
                                        <th scope="row"><?php echo e(__('Address:')); ?></th>
                                        <td> <?php echo e($patient->city); ?><?php echo e($patient->zip_code); ?><br/>
										<?php echo e($patient->user_address); ?> </td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <!-- Nav tabs -->
                                    ...
                                    <span class="d-none d-sm-block"><?php echo e(__('Latest Appoitments')); ?></span>
                            ...
                            <div class="tab-pane active" id="Medical_info" role="tabpanel">
                                <div class="table-responsive">
                                    <table class="table table-striped mb-0">
                                        <tbody>
											<tr>										
												<th scope="row"><?php echo e(__('ID')); ?></th>
												<th scope="row"><?php echo e(__('DATE')); ?></th>
												<th scope="row"><?php echo e(__('DOCTOR')); ?></th>
												<th scope="row"><?php echo e(__('Result')); ?></th>
												<th scope="row"><?php echo e(__('Options')); ?></th>
											</tr>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u931124233/domains/sislac.com.br/public_html/resources/views/patient/patient-profile.blade.php ENDPATH**/ ?>