            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?php if($receptionist): ?> <?php echo e(url('receptionist/' . $receptionist->id)); ?> <?php else: ?> <?php echo e(route('receptionist.store')); ?> <?php endif; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                            <?php echo csrf_field(); ?>
                            <?php if($receptionist): ?>
...
unset($__errorArgs, $__bag); ?>" tabindex="1"
                                                ...
                                                placeholder="<?php echo e(__('Digite o nome')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                name="email" tabindex="3" id="email" value="<?php if($receptionist): ?><?php echo e($receptionist->email); ?><?php elseif(old('email')): ?><?php echo e(old('email')); ?><?php endif; ?>" autocomplete="off"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="control-label"><?php echo e(__('Password')); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>" pattern=".{8,}"   autocomplete="off" required title="8 characters minimum"/>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u931124233/domains/sislac.com.br/public_html/resources/views/receptionist/receptionist-details.blade.php ENDPATH**/ ?>