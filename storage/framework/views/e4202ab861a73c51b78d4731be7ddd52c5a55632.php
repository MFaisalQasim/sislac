...
<?php $__env->startSection('body'); ?>
    ...
    display: inline; "
                                            ...
                                            <p> <b>
                                                    <font style="vertical-align: inherit; font-size: 11px;">
                                                        <font style="vertical-align: inherit;">
                                                            <a href="#"> Changes 1 in benign cells ?
                                                                .............</a>
                                                        </font>
                                                        <input class="form-control"
                                                            style="
                            ...
                            <div class="col-8 mt-4">
                                <div style="    float: right;">
                                    <button type="button" class="btn btn-outline-primary"><a
                                            href="/inserir-resultado8">Cancel</a></button>
                                    <button type="button" class="btn btn-primary"><a style="color:white"
                                            href="/inserir-resultado9">Save</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Devop360 Technology\Downloads\sislac\resources\views/appointment/add-appointment8.blade.php ENDPATH**/ ?>