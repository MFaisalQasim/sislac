...
<?php $__env->startSection('body'); ?>
                    ...
                    <div class="container-fluid">
                        <div class="row"  style="margin: 50px">
                            ...
                            <div class="col-md-12 col-lg-8">
                                ...
                                <p><b>
                                        <font style=" vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">SAMPLE EVALUATION:</font>
                                        </font>
                                    </b> <br> <b>
                                        <font style="    font-size: 11px; vertical-align: inherit;">
                                            <font style="vertical-align: inherit;">
                                                SATISFACTORY ...........................
                                            </font>
                                        </font>
                                        <input class="form-control"
                                            style=" width:50px !important; height: 25px!important;
    display: inline; "
    ...
    display: inline; "
                            ...
                            <div class="ol-md-12 col-lg-4" style="border: 1px solid #eff2f7;">
                                <p><b>
                                        <font style="vertical-align: inherit;">
                                    ...
                                    <font style="vertical-align: inherit;">
                                        <font style="vertical-align: inherit;"> <b><a href="#"> &nbsp; (SAMPLE
                                                    STANDARD)</a></b>
                                        </font>
                                    </font>
                                    </font>
                            ...
                            <div class="col-8 mt-4">
                                <div style="    float: right;">
                                    <button type="button" class="btn btn-outline-primary"><a
                                            href="/inserir-resultado5">Cancel</a></button>
                                    <button type="button" class="btn btn-primary"><a style="color:white"
                                            href="/inserir-resultado6">Save</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Devop360 Technology\Downloads\sislac\resources\views/appointment/add-appointment5.blade.php ENDPATH**/ ?>