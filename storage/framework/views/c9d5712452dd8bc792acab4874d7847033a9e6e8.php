    ...
    <?php $__env->startSection('content'); ?>
        ...
        <?php echo $__env->renderComponent(); ?> 		
		  <div class="row">
            ...
            <input class="form-control" style="     color: #556ee6; width:50px !important; height: 25px!important;
    display: inline; " type="text" name="destiny" value="YES"></b>  </font></p>
...
function changes_parameter_option(a,event){
	...
	$(a).parent().append("<h6>Yes</h6>");
       ...
       $('.fourth_question1_'+data_id).remove(); 
        ...
        <?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u931124233/domains/sislac.com.br/public_html/resources/views/appointment/add-appointment4.blade.php ENDPATH**/ ?>