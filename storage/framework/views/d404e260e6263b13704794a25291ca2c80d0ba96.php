                            ...
                            <div class="col-md-12 col-lg-8">
                                ...
                                <p><b>
                                        ...
                                        <input class="form-control"
                                            style="     color: #556ee6; width:50px !important; height: 25px!important;
    display: inline; "
                            ...
                            <div class="col-8">
                                <div style="    float: right;">
                                    <button type="button" class="btn btn-outline-primary"><a
                                            href="/inserir-resultado4">Cancel</a></button>
                                    <button type="button" class="btn btn-primary"><a style="color:white"
                                            href="/inserir-resultado5">Save</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Devop360 Technology\Downloads\sislac\resources\views/appointment/add-appointment4.blade.php ENDPATH**/ ?>