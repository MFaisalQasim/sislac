                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-9 text-right">
                                ...
                                <form action="">
                                    <div class="form-group d-inline-flex">
                                        <input class="form-control mr-1" type="text" placeholder="Pesquisar CRM" name="search_crm" value="<?php echo e($searchCRM); ?>" />
                                        <input class="form-control mr-1" type="text" placeholder="Pesquisar Nome" name="search_name" value="<?php echo e($search); ?>" />
                        ...
                        <table class="table table-bordered dt-responsive nowrap "
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('Especialidade')); ?></th>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td> <?php echo e($item->doctor['doc_specialty']); ?> </td>
                                        <td> 
                                             <?php
                                             //print_r($item->mobile);
                        ...
                        <div class="col-md-12 text-center mt-3">
                            <div class="d-flex justify-content-start">
                                 Mostrando de <?php echo e($doctors->firstItem()); ?> a <?php echo e($doctors->lastItem()); ?> de
                                <?php echo e($doctors->total()); ?> entradas
                            </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u931124233/domains/sislac.com.br/public_html/resources/views/doctor/doctors.blade.php ENDPATH**/ ?>