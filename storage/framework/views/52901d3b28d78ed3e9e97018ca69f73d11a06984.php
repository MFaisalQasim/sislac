                                ...
                                <div class="col-md-12 text-center mt-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 hideDiv question_box text-left">
                                            <h4 style="font-size: 11px !important;     font-weight: 400;">Subtitle: <span
                                                    style="font-size: 11px !important;    font-weight: 400;">SATISFACTORY</span>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
    ...
    <?php $__env->startSection('script-bottom'); ?>
        <script>
                        ...
                        if (data.Exam.length > 0) {
                            for (var i = 0; i < data.Exam.length; i++) {
                                ...
                                html += "<div class='d-flex' onclick='getExamParameter(" + data.Exam[i].exam_id +
                                    ")'><div class='BOX'>" + status111 +
                                    "</div><div class='alert alert-warning'  role='alert'>" + data.Exam[i].name +
                                    "</div>" +
                                    "</div>"
                            }
                    ...
                    success: function(data) {
                        ...
                        if (appoint_id == 10083) {
                            ...
                            if (data.new_param.length > 0) {
                                ...
                                $('.table_data').html(
                                    "<div style='display:flex;flex-wrap: wrap;' class='main'><h5>" + data
                                    .cytolies[0].name +
            ...
            $('body').on('keydown', '.second_question_parameter', function(e) {
                if (e.keyCode == 13) {
                    ...
                    if ($('.cytology_subitem').val() == 2) {
                        ...
                        $('.table_data').append(
                            "<div class='third_all_div'><div style='display:flex; width:100% !important' class='mt-3 fourth_question'><h5>MICROBIOLOGY:</h5><input  onkeyup='fourth_Question(this)' style='width:50px !important;' type='text' data-id class='form-control FOURTH_question_parameter'></div><div style='display:flex; width:100%;' class='mt-3 fourth_question1'><input  onkeyup='fourth_Question(this)' style='width:50px !important;' type='text' data-id class='form-control FOURTH_question_parameter'></div><div style='display:flex; width:100%;' class='mt-3 fourth_question2'><input  onkeyup='fourth_Question(this)' style='width:50px !important;' type='text' data-id class='form-control FOURTH_question_parameter'></div><div style='display:flex;width:100%;' class='mt-3 fourth_question3'><input  onkeyup='fourth_Question(this)' style='width:50px !important;' type='text' data-id class='form-control FOURTH_question_parameter'></div></div>"
                        );
                        cytology_subitem.forEach(function(item) {
            ...
            function changes_parameter_option(a, event) {
                ...
                var text = (data_id == 29) ? 'Reactive/non-neoplastic cell changes associated with:' : (data_id == 30) ?
                    'Changes in squamous epithelial cells:' : 'Changes in glandular cells:';
                var html = '';
                var html = '';
                $(a).parent().find("h6").remove("");
                ...
                if ($(a).val() == 1 && event.keyCode == 13) {
                    ...
                    for (var i = 0; i < length; i++) {
                        ...
                        html += "<div style='display: flex; width: 100%; margin: 10px auto;' class='changes_input_param_" +
                            data_id + "'>" + h6 +
                            "<input style='; width:50px !important;' onkeyup='getText(this)' type='text' data-id=" +
                            dataid + " class='form-control get_text_change'></div>"
                    }
                    $(a).parent().append(html)
                    var html = '';
                    html += "<div style='display:flex; width:100% !important;' class='mt-3 fourth_question_" + data_id +
                        "'><h5>MICROBIOLOGY:</h5><input  onkeyup='fourth_Question(this)' style='width:50px !important;' type='text' data-id=26 class='form-control FOURTH_question_parameter'></div>";

                    for (var j = 0; j < 3; j++) {
                        html += "<div style='display:flex; width:100%;' class='mt-3 fourth_question1_" + data_id +
                            "'><input  onkeyup='fourth_Question(this)' style='width:50px !important; margin-left: 50%; ' type='text' data-id class='form-control FOURTH_question_parameter'></div>";
                    }
                    $(a).parent().append(html)
                } else {
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sislac\resources\views/appointment/add-appointment.blade.php ENDPATH**/ ?>