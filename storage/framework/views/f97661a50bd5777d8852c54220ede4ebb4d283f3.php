...
<body data-topbar="dark" data-layout="horizontal">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Novo Exame</h4>
                            ...
                            <form action="<?php echo e(route('StoreExam')); ?>" name="examform" class="" method="post">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <option value="<?php echo e($item->abbreviation); ?>"><?php echo e($item->abbreviation); ?></option>
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <p>To insert reference values: ##REFERENCE## <br>To omit an excerpt when printing the report, enclose the text in.</p>
                                    </div>
                                ...
                                <br>
                                <p class="text-right"><button type="submit" class="btn btn-primary">Salvar</button></p>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="showTableModal" tabindex="-1" aria-labelledby="newParameterModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" id="report-parameters">
            <div class="modal-content form-group">
                <div class="modal-header">
                ...
                <div class="content" style="margin-top:30px;">
                    <div class="row">
                        <div class="col-lg-3">
                            <button type="button" class="btn btn-primary waves-effect waves-light mb-4" data-toggle="modal" data-target="#reportModal" id="new-record" onclick="hidePop()" data-backdrop="static" data-keyboard="false">
                        ...
                        <div class="row">
                            <div class="col-12 d-inline-flex">
                                <div class=" mb-3 mr-3">
									...
									<input type="hidden" name="exam_id" value="<?php echo e($last_id ? $last_id->id+1 : 1); ?>"/>
                                </div>
                                <div class=" mb-3 mr-3">
    ...
    $("#reportParameterForm").on("submit", function(e) {
        ...
        //console.log(lastListItem);return false;
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u931124233/domains/sislac.com.br/public_html/resources/views/exam/registerexam.blade.php ENDPATH**/ ?>