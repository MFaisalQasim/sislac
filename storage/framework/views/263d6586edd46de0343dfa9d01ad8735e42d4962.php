                            ...
                            <div class="col-8">
                                <div style="    float: right;">
                                    <button type="button" class="btn btn-outline-primary"><a
                                            href="/inserir-resultado3">Cancel</a></button>
                                    <button type="button" class="btn btn-primary"><a style="color:white"
                                            href="/inserir-resultado4">Save</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Devop360 Technology\Downloads\sislac\resources\views/appointment/add-appointment3.blade.php ENDPATH**/ ?>