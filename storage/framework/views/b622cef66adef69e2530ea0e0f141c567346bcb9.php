  ...
  <?php $__env->stopSection(); ?> 
    <?php $__env->startSection('content'); ?>
        ...
        <?php $__env->startComponent('components.breadcrumb'); ?>
            <?php $__env->slot('title'); ?> VERIFICAR RESULTADO <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_1'); ?> Dashboard <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_2'); ?> Appointment <?php $__env->endSlot(); ?>
        <?php echo $__env->renderComponent(); ?>

		
		<div class="d-flex justify-content-end align-items-sm-baseline">
        <p class="mr-3">ID Atendimento</p>
		
			<input type="text" class="form-control appointmentId" name="appointmentId"  onkeyup="getAppointment(this.value)"  style="width: 90px !important;"/>
		...
		<?php if( $approved == "IS_APPROVED"): ?>
		<button class="btn btn-success ml-3 print-window"  onclick="printWindow()"><i class="fa fa-print "></i></button>
			
		<a href="/verificar-resultado"><button type="" name="approve" value="IS_APPROVED" class="btn btn-primary m-2">Back</button>	</a>
		<?php endif; ?>
		...
		<div>
			<div class="container">
				<img src="https://sislac.com.br/public/img/LAB VIDA.png" class="img-fluid img-size"/>
				<hr/>
				<div class="row">
					<div class="col-md-6">
                        <h5 class="d-flex">Paciente : <span id="paciente"></span></h5>						
						<h5 class="d-flex">Idade : <span id="idade"></span></h5>						
						<h5 class="d-flex">Convenio : <span id="convenio"></span></h5>						
						<h5 class="d-flex">Medico(a) : <span id="medico"></span></h5>						
					</div>

					<div class="col-md-6">
						<h5 class="d-flex">Protocolo : <span id="protocolo"></span></h5>					
						<h5 class="d-flex">Sexo : <span id="sexo"></span></h5>					
						<h5 class="d-flex">Cadastro : <span id="cadastro"></span></h5>					
						<h5 class="d-flex">Emissao : <span id="emissao"></span></h5>
					</div>
				</div>
				...
				<hr/>
				<p><b>NOTA:</b>
				 Este laudo e uma anlise citomorfologica cuja elaboracao e baseada em informacoes clinicas e conhecimento tecnio previo (Sistema Bethesda, 2014) podendo o
				 diganostico variar, na dependencia dos dados obtidos, das tecnicas empregadas, da evolucao cientifica e histopatologico nao responsabilizando interpretacao divergente. Tendo
				 em vista a sensibilidade e a especificidade da metodologia ate que o caso seja efetivamente elucidado.<br><br>
				 Estes resultados nao sao conclusivos. Sao exames coplementares e, como tal,<br>
				 deverao ser avaliados pelo medico assistente para correlacao com a clinica e<br>
				 decisao diagnostica e/ou terapeutica.
			    </p>

				<div class="d-flex justify-content-end">
                     <div class="text-center">
					 <p><b>Dr Francuar A da S. Junio</b><br>
					 <b>Biomedico Citologista</b><br>
					 <b>CRBM/PB 12.029</b></p>
					 </div>
				</div>
				<div class="text-center py-2" style="background-color:#eff2f7;">
                   <h4 style="color:#32cb93">www.labvidaoficial.com.br</h4>
				</div>
				<div class="text-center">
					<p><b>Av. Presidente Juscelino Kubitschek, 1169 | Sao Bneto-PB-58868-000 | (83) 99610-1469</b></p>					
				</div>
				<div class="text-center">
				<a class="btn btn-primary" href="/verificar-resultado" type="button" >Reprovar</a>
				
				<form action="verificar-resultado/approve" style="    display: contents;">
					<button  class="btn btn-primary"type="submit" name="approve" value="IS_APPROVED" class="btn btn-primary">Aprovar</button>	
				</form>
				</div>			
				</div>			
			</div>
                                    ...
                                    <thead>
									   ...
									   <!-- </tr>
                                        ...
                                        <tbody>
                                             <tr>
											  <td>
												<input type="text" class=" appointmentId" onkeyup="getAppointment(this.value)"/>   
											   </td> -->
											   <!-- <td>
            ...
            function getAppointment(id){
              ...
              success:function(data){ 
				...
				if(data.data.length>0){
					$("#paciente").text(data.data[0].patient_name);
					$("#idade").text(data.data[0].age);
					$("#convenio").text(data.data[0].ins_company);
					$("#medico").text(data.data[0].doctor);
					$("#protocolo").text(data.data[0].id);
					$("#sexo").text(data.data[0].gender);
					$("#cadastro").text(data.data[0].appointment_date);	
				}
				let status1123;
			     var html='';           
...
function changes_parameter_option(a,event){
    ...
    window.print();
        ...
        <?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sislac\resources\views/appointment/verify-result.blade.php ENDPATH**/ ?>