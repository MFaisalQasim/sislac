<?php $__env->startSection('title'); ?> <?php echo e(__('New Appointement Page')); ?> <?php $__env->stopSection(); ?>
<style>
    body {
...
<body data-topbar="dark" data-layout="horizontal">
  <?php $__env->stopSection(); ?> 
        ...
        <?php echo $__env->renderComponent(); ?> 		
		  <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="row">
                                ...
                                <div class="col-8">
                                    <p><b><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">CITOLÓGIA CÉRVICO-VAGINAL</font></font></b><br></font></p>
                                    <b><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Método:&nbsp;</font></font></b>    <font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
               CONVENCIONAL (PAPANICOLAU)
            </font></font><br></font>
             <b><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Material Biológico:&nbsp;</font></font></b>    <font style="vertical-align: inherit;"><font style="vertical-align: inherit;">
            ...
            <div class="row">
                <div class="col-12">
                <div class="col-6  p-0">
        <p><b><font style="vertical-align: inherit; "><font style="vertical-align: inherit;">SAMPLE SUITABILITY:</font></font></b>  <br>
    </p>
                      <p> <b> <font style="vertical-align: inherit; font-size: 11px;"><font style="vertical-align: inherit;">
               SATISFACTORY ...........................
            </font>
            <input class="form-control" style="float: right; width: 50px !important; height: 25px!important;
    display: inline;  color: #556ee6;" type="text" name="destiny" value="YES"></font></b>
    </p>
             <p> <b> <font style="vertical-align: inherit; font-size: 11px;"><font style="vertical-align: inherit;">
               SAMPLE STANDARD ............
            </font>
            <input class="form-control" style="float: right; width: 50px !important; height: 25px!important;
    display: inline;  color: #556ee6;" type="text" name="destiny" value=""></font></b>
    </p>
                <p><b><font style="vertical-align: inherit; font-size: 11px;"><font style="vertical-align: inherit;">EPITHELIUM REPRESENTED IN THE SAMPLE
            </font></font></b> </p> 
            ...
            <div class="col-6">         
                <div style="float:right">
                    <p><input class="form-control" style=" width: 45px !important; height: 25px!important;
                    display: inline;  " type="text" name="destiny" value=""></p> 
                    </div>
            </div>
            <div class="col-6 p-0">
    <p><input class="form-control" style="width: 100%!important; height: 25px!important;
    display: inline;  " type="text" name="destiny" value=""></p> 
             ...
             <div class="col-6 p-0">
                 <p><b><font style="vertical-align: inherit; "><font style="vertical-align: inherit;">SAMPLE DESCRIPTIVE DIAGNOSIS</font></font></b>  <br>
    </p>
                      
        </p><p> <b> <font style="vertical-align: inherit; font-size: 11px;"><font style="vertical-align: inherit;">
                Changes ? .............
            </font>
            <input class="form-control" style="
     float: right; width: 50px !important; height: 25px!important;
    display: inline; " type="text" name="destiny" value="YES"></font></b>
    </p>
    <p> <b> <font style="vertical-align: inherit; font-size: 11px;"><font style="vertical-align: inherit;">
    ...
    display: inline; " type="text" name="destiny" value="YES"></font></b>
                      ...
                      <p> <b> <font style="vertical-align: inherit; font-size: 11px;"><font style="vertical-align: inherit;">
              <a href="#"> Changes 3 in glandular cells ?...............</a>
            </font>
            <input class="form-control" style="    color: #556ee6;
     float: right; width: 50px !important; height: 25px!important;
    display: inline; " type="text" name="destiny" value="YES"></font></b>
    </p>
     ...
     <p> <b> <font style="vertical-align: inherit; font-size: 11px;"><font style="vertical-align: inherit;">
            ...
            <div class="col-6">         
                <div style="float:right">
                    ...
                    <input class="form-control" style="margin-bottom:10px; width: 45px !important; height: 25px!important;
                    display: inline;  " type="text" name="destiny" value="">
                    <br/>
                    </div>
            </div>
            
            <div class="col-6  p-0">
    <input class="form-control" style="margin-bottom:10px;width: 100%!important; height: 25px!important;
    display: inline;  " type="text" name="destiny" value="">
                    <br/>
    ...
    <div class="col-12 p-0">
                 ...
                 <div class="d-flex">
                     <label> <b>note:</b> </label> <textArea  class="form-control" style="width: 100%!important; height: 45px!important;  display: inline;"></textArea>
                 </div>
        <p> <b> <font style="vertical-align: inherit; font-size: 11px;"><font style="vertical-align: inherit;">
               MICROBIOLOGY
            </font>
    ...
    <!--</div>
            ...
            <div class="col-6">         
                <div style="float:right">
                    ...
                    display: inline;  " type="text" name="destiny" value="">
                    <br/>
                    <p><input class="form-control" style="margin-bottom:10px; width: 45px !important; height: 25px!important;
                    display: inline;  " type="text" name="destiny" value=""></p> 
                    </div>
            </div>
    ...
    display: inline;  " type="text" name="destiny" value="">
                    <br/>
    <p><input class="form-control" style="margin-bottom:10px;width: 100%!important; height: 25px!important;
    display: inline;  " type="text" name="destiny" value=""></p> 
            ...
            <p> <b> <font style="vertical-align: inherit; font-size: 11px;"><font style="vertical-align: inherit;">
             NILM - NEGATIVE FOR INTRA-EPITHELIAL LESION OR MALIGNITY IN THE EXAMINED MATERIAL
            </font> </font>
            </b>
    </p>
                 <div class="col-6  p-0">
            ...
            <input class="form-control" style="    color: #556ee6;
     float: right; width: 50px !important; height: 25px!important;
    display: inline; " type="text" name="destiny" value=""></font></b>
    </p>
                 </div>
                 
               <div style="    float: right;">
                        <button href="/inserir-resultado1" type="button" class="btn btn-outline-primary"><a href="/inserir-resultado8">Cancel</a></button>
        <button type="button" class="btn btn-primary"><a style="color:white" href="/inserir-resultado9">Save</a></button>
                   </div>
            </div>
                                ...
                                <div class="col-4" style="border: 1px solid #eff2f7;">   <p><b><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">SUBTITLE  </font></font></b><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><a href="#"> &nbsp;  (UNSATISFACTORY)</a>
            </font></font></font></p>
	...
	function updateAppointmentStatus(id,status){
		 $.ajax({
		   ...
		   var appoint_id = $(".appointmentId").val();
              ...
              type: "GET",
              url: "getexambyid",
              data: {id:id,appoint_id:appoint_id, "_token": "<?php echo e(csrf_token()); ?>"},
              success:function(data){
				  console.log(data);
...
function getJson(){
	...
	function getResults1(){
		  ...
		  $.ajax({
              ...
              data: {data:res_array,table_json:JSON.stringify(table_json),"_token": "<?php echo e(csrf_token()); ?>"},
              success:function(data){
				 console.log(data);
              } 
              })
       ...
       //});
		...
		// console.log(res_array);return false;
		  $.ajax({
              type: "POST",
              url: "insertResultParameters",
              data: {data:$('.table_data').html(), 'Status' : Status, appointment_id:id, exam_id:exam_id, "_token": "<?php echo e(csrf_token()); ?>"},
              success:function(data){
...
function changes_parameter_option(a,event){
	...
	$(a).parent().append("<h6>Yes</h6>");
       ...
       $('.fourth_question1_'+data_id).remove(); 
        ...
        <?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u931124233/domains/sislac.com.br/public_html/resources/views/appointment/add-appointment9.blade.php ENDPATH**/ ?>