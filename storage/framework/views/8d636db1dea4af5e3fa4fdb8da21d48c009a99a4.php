                    ...
                    <?php if($role == 'admin'): ?>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                <a href="<?php echo e(url('doctor')); ?>" class="dropdown-item"><?php echo e(__('Lista de Médicos')); ?></a>
                                <a href="<?php echo e(route('doctor.create')); ?>"
                                    class="dropdown-item"><?php echo e(__('Novo Médico')); ?></a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layout" role="button"
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                ...
                                <a href="<?php echo e(route('receptionist.create')); ?>"
                                    class="dropdown-item"><?php echo e(__('Novo Recepcionista')); ?></a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('createAppointment')); ?>">
                                    <?php echo e(__('Novo Atendimento')); ?>

                                </a>
                                <a class="dropdown-item" href="<?php echo e(url('inserir-resultado')); ?>">
                                    <?php echo e(__('Inserir Resultado')); ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('cytology')); ?>">
                                    <?php echo e(__('Citologia')); ?>
...
<?php /**PATH /home/u931124233/domains/sislac.com.br/public_html/resources/views/layouts/hor-menu.blade.php ENDPATH**/ ?>