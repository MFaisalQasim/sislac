                ...
                function changes_parameter_option(a, event) {
                    ...
                    if ($(a).val() == 1 && event.keyCode == 13) {
                        ...
                        for (var i = 0; i < length; i++) {
                            ...
                            html += h6 ;"<br/> <hr/>" " <div style='display: block; width: 100%; margin: 10px auto;' class='changes_input_param_" +
                                data_id + "'>" 
                        ...
                        var html = '';
                        html += "<h5>MICROBIOLOGY:</h5><div style='display:flex; width:100% !important;' class='mt-3 fourth_question_" + data_id +
                            "'><input  onkeyup='fourth_Question(this)' style='width:50px !important;' type='text' data-id=26 class='form-control FOURTH_question_parameter'></div>";
