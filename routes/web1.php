...
Route::get('appointmentData', 'AppointmentController@appointmentdata');
...
// Categories
    ...
    Route::get('storecytologysubitem', [CytologyController::class, 'addSubItem'])->name('cytologyAddSubitem');
